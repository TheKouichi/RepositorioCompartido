...
public class TestRectangulo {
	...
	public static void main(String[] args)
	{
		...
		System.out.println("La base del rectangulo rect3 es: " + rec3.getBase());
		...
		System.out.println("El area de este rectangulo es: " + rec2.area());
		System.out.println("La altura del rectangulo es: " + rec2.getAltura());
	}
